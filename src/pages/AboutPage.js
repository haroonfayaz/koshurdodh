...
const AboutPage = () => {
  return (
    <>
      <SEOHead
        title="About Koshur Dodh - Our Story & Mission | Kashmir Dairy Products"
        description="Learn about Koshur Dodh's journey to bring pure, fresh dairy products from Kashmir valley to your doorstep. Our mission, vision, and commitment to quality."
        keywords="about Koshur Dodh, Kashmir dairy story, pure milk mission, dairy company Kashmir, fresh milk vision"
      />
      <Box
