...
const ContactPage = () => {
  ...
  return (
    <>
      <SEOHead
        title="Contact Koshur Dodh - Order Fresh Dairy Products | Srinagar Kashmir"
        description="Contact Koshur Dodh for fresh dairy product orders and inquiries. Located in Illahibagh, Srinagar. Call +91 6005141549 or email us for home delivery."
        keywords="contact Koshur Dodh, order milk Srinagar, dairy contact Kashmir, milk delivery contact, Illahibagh dairy, WhatsApp milk order"
      />
      <Box
        sx={{
          minHeight: "100vh",
